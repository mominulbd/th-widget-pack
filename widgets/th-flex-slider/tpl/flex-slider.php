	...
	<ul class="slides">
		...
		<?php foreach( $instance['slides'] as $i => $slide ) { ?>
			...
			<li>
				...
				<div class="slider-bg slide-cal-center light-text themo_slider_<?php echo $init_main_loop; ?>" style=" background-image:url('http://stratus-3c99.kxcdn.com/stratus/wp-content/uploads/2015/11/home-app-gradient.jpg');    ">
					...
					<div class='container'>
						...
						<div class="row lrg-txt ">
							...
							<div class="slider-subtitle  ">
								<?php echo do_shortcode( wp_kses_post( $slide['content'] ) ); ?>
							</div>

							<?php if( $slide['button_1']['button']['button_link']['link']['url'] || $slide['button_2']['button']['button_link']['link']['url'] ) : ?>
